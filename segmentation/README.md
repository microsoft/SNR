...
### GTA5-to-Cityscapes:
(Note) Please refer to the scheme of SNR-MS (ours) in Section 4.2- of our arxiv paper SNR-extension.

(Optional) Pretrain the model on the source domain (GTA5), this is also our SNR shceme on the domain generalization setting. 
...
Then in next adaptation step, set `--pretrained_ckpt_file "./log/gta5_pretrain/gta5final.pth"`.

- SNR embedded backbone:
