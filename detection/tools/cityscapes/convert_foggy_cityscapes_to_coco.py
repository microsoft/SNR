...
def convert_foggy_cityscapes_instance_only(
    ...
    for data_set, ann_dir in zip(sets, ann_dirs):
        ...
        images = []
        annotations = []
        ann_dirs = data_dir+ann_dir
        for root, _, files in os.walk(ann_dirs):
...
if __name__ == '__main__':
    ...
    if args.dataset == "foggy_cityscapes":
        convert_foggy_cityscapes_instance_only('/data/home/v-xiji/HPC_xiji/Dataset/CityScape', '/data/home/v-xiji/HPC_xiji/Dataset/CityScape_foggy/foggy_cityscapes_cocostyle')
    else:
